...
const MAT_EQUIPMENT = [
  { id: 'mat', label: 'Mat', emoji: 'Ã°ÂÂÂ©' },
  { id: 'theraband', label: 'Theraband', emoji: 'Ã°ÂÂÂÃ¯Â¸Â' },
  { id: 'magic-circle', label: 'Magic Circle', emoji: 'Ã¢Â­Â' },
  { id: 'small-ball', label: 'Small Ball', emoji: 'Ã°ÂÂÂµ' },
  { id: 'foam-roller', label: 'Foam Roller', emoji: 'Ã°ÂÂªÂµ' },
  { id: 'weights', label: 'Hand Weights', emoji: 'Ã°ÂÂÂÃ¯Â¸Â' },
  { id: 'block', label: 'Yoga Block', emoji: 'Ã°ÂÂ§Â±' },
  { id: 'strap', label: 'Stretch Strap', emoji: 'Ã°ÂÂªÂ¢' },
]

const REFORMER_EQUIPMENT = [
  { id: 'reformer', label: 'Reformer', emoji: 'Ã¢ÂÂÃ¯Â¸Â' },
  { id: 'box', label: 'Long/Short Box', emoji: 'Ã°ÂÂÂ¦' },
  { id: 'jump-board', label: 'Jump Board', emoji: 'Ã°ÂÂ¦Â' },
  { id: 'magic-circle', label: 'Magic Circle', emoji: 'Ã¢Â­Â' },
  { id: 'pole', label: 'Pole / Dowel', emoji: 'Ã°ÂÂªÂ' },
  { id: 'theraband', label: 'Theraband', emoji: 'Ã°ÂÂÂÃ¯Â¸Â' },
  { id: 'weights', label: 'Hand Weights', emoji: 'Ã°ÂÂÂÃ¯Â¸Â' },
  { id: 'platform-extender', label: 'Platform Extender', emoji: 'Ã°ÂÂÂ' },
]

const BLOCK_EMOJIS = ['Ã°ÂÂÂ','Ã°ÂÂ§Â','Ã°ÂÂÂª','Ã°ÂÂÂ¥','Ã°ÂÂ§Â','Ã¢ÂÂ¡','Ã°ÂÂÂ','Ã°ÂÂÂ¯','Ã°ÂÂÂ','Ã°ÂÂÂ¿','Ã¢ÂÂ¨','Ã°ÂÂ¦Â','Ã°ÂÂÂ¸','Ã°ÂÂÂµ','Ã°ÂÂÂ']
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ PDF Export Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
async function exportToPDF(className: string, setup: { format: 'mat' | 'reformer'; duration: number; level: string }, blocks: ClassBlock[], blockMovements: Record<string, Movement[]>, blockNotes: Record<string, string>, equipment: Set<string>) {
  ...
  doc.text(`${setup.format === 'mat' ? 'Mat Pilates' : 'Reformer Pilates'} ÃÂ· ${setup.duration} min ÃÂ· ${setup.level.charAt(0).toUpperCase() + setup.level.slice(1)}`, margin, 21)
  doc.setFontSize(8); doc.text(`Generated by Pilates Music Builder ÃÂ· ${new Date().toLocaleDateString()}`, pageW - margin, 21, { align: 'right' })
  y = 36
  ...
  if (equipmentList.length > 0) {
    ...
    doc.setFontSize(9); doc.setFont('helvetica', 'normal'); doc.setTextColor(...(DARK as [number, number, number])); doc.text(equipmentList.join('  ÃÂ·  '), margin, y); y += 8; drawLine()
  }
  for (const block of blocks) {
    ...
    doc.setFontSize(8); doc.setFont('helvetica', 'normal'); doc.text(`${bMins}:${bSec}${blockBpm ? ` ÃÂ· avg ${blockBpm} BPM` : ''} ÃÂ· ${block.songs.length} tracks`, pageW - margin - 4, y + 7, { align: 'right' }); y += 14
    if (movements.length > 0) { checkPage(10); doc.setFontSize(8); doc.setFont('helvetica', 'bold'); doc.setTextColor(...(GREEN as [number, number, number])); doc.text('Movements:', margin + 2, y); doc.setFont('helvetica', 'normal'); doc.setTextColor(...(GRAY as [number, number, number])); const movLines = doc.splitTextToSize(movements.map(m => m.name).join('  ÃÂ·  '), contentW - 30); doc.text(movLines, margin + 25, y); y += movLines.length * 4 + 3 }
  ...
  doc.setFontSize(7); doc.setTextColor(...(LIGHTGRAY as [number, number, number])); doc.text('Pilates Music Builder ÃÂ· pilates-music-builder.vercel.app', pageW / 2, pageH - 8, { align: 'center' })
  doc.save(`${className.replace(/[^a-z0-9]/gi, '_')}_class_plan.pdf`)
}

// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Energy Arc Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Setup Screen Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    ...
    <div className="max-w-2xl mx-auto py-10 px-4">
            ...
            {savedClasses.map(c => (
              <div key={c.id} className="flex items-center gap-2 px-4 py-3 rounded-xl border border-cream-300 bg-white hover:border-sage-300 transition-all">
                <button onClick={() => onLoad(c)} className="flex-1 text-left">
                  ...
                  <p className="text-xs text-sage-400 mt-0.5">{c.format === 'mat' ? 'Ã°ÂÂ§Â Mat' : 'Ã¢ÂÂÃ¯Â¸Â Reformer'} ÃÂ· {c.duration} min ÃÂ· {c.level} ÃÂ· {new Date(c.updated_at).toLocaleDateString()}</p>
                </button>
                ...
                <button onClick={() => onLoad(c)} className="shrink-0 text-sage-400 text-sm hover:text-sage-600">Load Ã¢ÂÂ</button>
              </div>
            ))}
          </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-2 gap-3">
          {([{ value: 'mat', label: 'Mat Pilates', emoji: 'Ã°ÂÂ§Â', desc: 'Floor-based, flowing movement' }, { value: 'reformer', label: 'Reformer Pilates', emoji: 'Ã¢ÂÂÃ¯Â¸Â', desc: 'Machine-based, resistance work' }] as const).map(f => (
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-3 gap-2">
          {([{ value: 'beginner', label: 'Beginner', emoji: 'Ã°ÂÂÂ±' }, { value: 'intermediate', label: 'Intermediate', emoji: 'Ã¢Â­Â' }, { value: 'advanced', label: 'Advanced', emoji: 'Ã°ÂÂÂ' }] as const).map(l => (
      ...
      <button onClick={() => onStart(format, duration, level)} className="w-full py-4 bg-sage-500 hover:bg-sage-600 text-white font-bold text-base rounded-2xl transition-colors shadow-sm">Build Class Structure Ã¢ÂÂ</button>
    </div>
  )
}

// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Block Name Editor Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    ...
    <div className="flex items-center gap-1.5 min-w-0">
      ...
      {editing ? (
        ...
        <button onClick={e => { e.stopPropagation(); setEditing(true) }}
          ...
          {name}<span className="ml-1 opacity-0 group-hover:opacity-40 text-xs font-normal">Ã¢ÂÂÃ¯Â¸Â</span>
        </button>
      )}
    </div>
  )
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Custom Block BPM Picker Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    ...
    <div className="mb-5">
      ...
      <div className="mb-5 p-4 bg-sage-50 rounded-xl border border-sage-100">
        ...
        <p className="text-xs text-sage-400 mt-2 text-center">
          Songs filtered to <span className="font-semibold text-sage-600">{block.bpmMin}Ã¢ÂÂ{block.bpmMax} BPM</span>
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-xs text-sage-400 mb-3">Browse or search Ã¢ÂÂ selecting movements auto-updates BPM range</p>
        ...
        {/* Movement list Ã¢ÂÂ scrollable */}
                ...
                {displayed.map(m => {
                  ...
                  return (
                    <button key={m.id} onClick={() => onToggle(m)}
                      ...
                      {selected && <span>Ã¢ÂÂ</span>}{m.name}
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Template Movement Picker Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function MovementPicker({ block, format, level, selectedMovements, onToggle }: {
  ...
  return (
    <div className="mb-5">
      <div className="flex items-center justify-between mb-3">
        <div><h4 className="text-sm font-semibold text-sage-700">Movements</h4><p className="text-xs text-sage-400">Select what you're teaching Ã¢ÂÂ songs will match</p></div>
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Block Notes Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Block Card Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
        ...
        <div className="flex items-start justify-between gap-2 mb-2">
          <div className="flex-1 min-w-0" onClick={onActivate}>
            <div className="flex items-center gap-1.5 mb-1">
              ...
              {isFull && <span className="text-xs font-semibold px-1.5 py-0.5 rounded-full bg-green-100 text-green-700">Ã¢ÂÂ Full</span>}
              {isOver && <span className="text-xs font-semibold px-1.5 py-0.5 rounded-full bg-red-100 text-red-600">Over</span>}
              {hasNotes && <span className="text-xs">Ã°ÂÂÂ</span>}
            </div>
        ...
        <button onClick={onActivate} className="w-full text-left">
          <div className="flex items-center justify-between mb-2">
            <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${colors.badge}`}>
              {targetBpm ? `~${targetBpm} BPM` : `${block.bpmMin}Ã¢ÂÂ${block.bpmMax} BPM`}
            </span>
          ...
          <div className="flex items-center gap-2 mt-2" onClick={e => e.stopPropagation()}>
            ...
            {isCustomBlock(block.id) && (
              <>
                ...
                <span className="text-xs text-sage-300">Ã¢ÂÂ</span>
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Sortable Block Card Wrapper Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Equipment Checklist Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
        ...
        {items.map(item => {
          ...
          return (
            <button key={item.id} onClick={() => onToggle(item.id)}
              ...
              {checked && <span className="ml-auto text-xs">Ã¢ÂÂ</span>}
            </button>
          )
        })}
      </div>
        ...
        {blocks.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <div className="w-14 h-14 rounded-2xl bg-cream-100 flex items-center justify-center mb-3">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#9caf9c" strokeWidth="1.5">
                <path d="M12 5v14M5 12h14"/>
              </svg>
            </div>
            <p className="text-sm font-semibold text-sage-600 mb-1">No blocks yet</p>
            <p className="text-xs text-sage-400 mb-4">Build your class structure by adding blocks</p>
            <button onClick={addBlock}
              className="flex items-center gap-2 px-4 py-2 bg-sage-500 hover:bg-sage-600 text-white text-sm font-semibold rounded-xl transition-colors">
      ...
      {allSongs.length > 0 && (
        <div className="space-y-2">
          <button onClick={onSave} disabled={saveStatus === 'saving'}
            ...
            {saveStatus === 'saving' ? 'Ã¢ÂÂ³ Saving...' : saveStatus === 'saved' ? 'Ã¢ÂÂ Saved!' : saveStatus === 'error' ? 'Ã¢ÂÂ Error Ã¢ÂÂ try again' : savedId ? 'Ã°ÂÂÂ¾ Update Saved Class' : 'Ã°ÂÂÂ¾ Save Class'}
          </button>
          <button onClick={onExportPDF} className="w-full py-2.5 bg-sage-700 hover:bg-sage-800 text-white font-semibold text-sm rounded-xl transition-colors">Ã°ÂÂÂ Export as PDF</button>
          <button onClick={onCopy} className="w-full py-2.5 bg-white hover:bg-sage-50 border border-sage-200 text-sage-700 font-semibold text-sm rounded-xl transition-colors">Ã°ÂÂÂ Copy Class Plan</button>
        </div>
      )}
    </div>
  )
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Main ClassBuilder Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
export default function ClassBuilder() {
  ...
  function copyFullClass() {
    ...
    const lines = [`${className}`, `${setup.format === 'mat' ? 'Ã°ÂÂ§Â Mat' : 'Ã¢ÂÂÃ¯Â¸Â Reformer'} Pilates Ã¢ÂÂ ${setup.duration} min Ã¢ÂÂ ${setup.level.charAt(0).toUpperCase() + setup.level.slice(1)}`, '', ...(equipmentList ? [`Ã°ÂÂÂ¦ Equipment: ${equipmentList}`, ''] : []), ...blocks.flatMap(b => { const movements = blockMovements[b.id] ?? []; const note = blockNotes[b.id] ?? ''; const bSecs = b.songs.reduce((a, s) => a + (s.duration ?? 0), 0); const bMins = Math.floor(bSecs / 60); const bSec = String(bSecs % 60).padStart(2, '0'); return [`${b.emoji} ${b.name} (${bMins}:${bSec})`, ...(movements.length > 0 ? [`   Movements: ${movements.map(m => m.name).join(', ')}`] : []), ...(note ? [`   Notes: ${note}`] : []), ...b.songs.map((s, i) => { const dur = s.duration ?? 0; const m = Math.floor(dur / 60); const sec = String(dur % 60).padStart(2, '0'); return `   ${i + 1}. ${s.title ?? s.name} Ã¢ÂÂ ${s.artist} (${s.bpm} BPM, ${m}:${sec})` }), ''] })]
        ...
        {activeBlock && setup ? (
          <>
            <div className="bg-cream-50 border border-cream-200 rounded-2xl p-5 mb-5">
              {isCustomBlock(activeBlock.id) ? (
                ...
                <>
                  ...
                  {activeMovements.length === 0 && <p className="text-xs text-sage-400 italic mb-5">No movements selected Ã¢ÂÂ showing songs in the {activeBlock.bpmMin}Ã¢ÂÂ{activeBlock.bpmMax} BPM range. Select movements to refine.</p>}
                </>
              )}
            ...
            <div className="flex items-center gap-3 mb-4 flex-wrap">
              <div>
                ...
                <p className="text-sm text-sage-400">
                  {activeBpmRange[0]}Ã¢ÂÂ{activeBpmRange[1]} BPM
                  {!isCustomBlock(activeBlock.id) && activeMovements.length > 0 ? ` ÃÂ· based on ${activeMovements.length} movement${activeMovements.length > 1 ? 's' : ''}` : ''}
                </p>
              </div>
                ...
                {songSource === 'library' && (
                  <>
                    <select value={sortBy} onChange={e => setSortBy(e.target.value)} className="px-3 py-2 text-sm bg-white border border-cream-300 rounded-xl text-sage-700 focus:outline-none focus:border-sage-400">
                      ...
                      <option value="bpm-asc">BPM: Low Ã¢ÂÂ High</option>
                      <option value="bpm-desc">BPM: High Ã¢ÂÂ Low</option>
            ...
            {songSource === 'spotify' ? (
              ...
              <div className="text-center py-16"><div className="text-4xl mb-3">Ã°ÂÂÂ</div><p className="text-sage-500">No songs found in {activeBpmRange[0]}Ã¢ÂÂ{activeBpmRange[1]} BPM range</p></div>
            ) : (
              <>
